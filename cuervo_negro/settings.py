"""
Django settings for Cuervo Negro Barber-Tattoo
"""
...
ALLOWED_HOSTS = config("ALLOWED_HOSTS", default="192.168.0.9").split(",")
...
INSTALLED_APPS = [
    ...
    "apps.barberos.apps.BarberosConfig",
...
ROOT_URLCONF = "cuervo_negro.urls"
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "apps.citas.context_processors.notificaciones_navbar",
            ],
        },
    },
]

WSGI_APPLICATION = "cuervo_negro.wsgi.application"
